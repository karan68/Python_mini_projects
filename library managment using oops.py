...
def main():
    ...
    while (Exit is not True):
        ...
        if _input == "q":
            ...
            print("\n Book Lend \n")
            karan.lend_book(_input3, _input2)
            ...
            karan.return_book(_input3, _input2)
